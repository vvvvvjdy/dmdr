...
def parse_args():
    ...
    parser.add_argument("--sample-type", type=str, default="sde", choices=["ode", "sde"])
    ...
    parser.add_argument("--one-dtype", type=str, default="fp32", choices=["fp32", "fp16", "bf16"],help="only for debug")
    ...
    # reward SRPO
    parser.add_argument("--srpo-k", type=float, default=0.1, help="scale for srpo reward, small value")
